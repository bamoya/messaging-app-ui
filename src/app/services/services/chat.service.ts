...
import { getUserChats } from '../fn/chat/get-user-chats';
import { GetUserChats$Params } from '../fn/chat/get-user-chats';
...
export class ChatService extends BaseService {
  ...
  /** Path part for operation `getUserChats()` */
  static readonly GetUserChatsPath = '/chats';

  /**
   * This method provides access to the full `HttpResponse`, allowing access to response headers.
   * To access only the response body, use `getUserChats()` instead.
   *
   ...
   * To access the full response (for headers, for example), `getUserChats$Response()` instead.
   *
   * This method doesn't expect any request body.
   */
